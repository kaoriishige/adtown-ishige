// ----------------------------------------------------------
// ★ 事業者側・ユーザー側で共通利用するカテゴリ定義
// ----------------------------------------------------------

// profile.tsx の categoryData と全く同じ内容
export const categoryData: Record<string, string[]> = {
  ...
  "買い物関連": ["農産物直売所", "鮮魚店", "雑貨店・民芸品店", "花屋", "お土産店", "リサイクルショップ","道の駅・特産品店","その他"],
  "美容・健康関連": ["美容室", "ネイルサロン", "エステサロン", "リラクゼーション","マッサージ", "整体・整骨院・鍼灸院", "カイロプラクティック","クリニック・歯科医院","薬局・ドラッグストア", "その他"],
  "住まい・暮らし関連": ["工務店・建築・リフォーム", "リフォーム専門店", "水道・電気工事", "不動産会社", "造園・植木屋", "ハウスクリーニング","家電修理・メンテナンス","便利屋", "その他"],
