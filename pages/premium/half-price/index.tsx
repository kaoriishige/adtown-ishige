...
const HalfPriceIndexPage: NextPage<HalfPriceIndexProps> = ({ initialPosts }) => {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] pb-24 font-sans text-gray-900 text-left">
            ...
            <header className="bg-white border-b px-6 py-4 sticky top-0 z-50 shadow-sm">
                <div className="max-w-xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <button onClick={() => router.push('/premium/dashboard')} className="p-1">
                        ...
                        <div key={post.id} className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-50 group">
                            <div className="aspect-[4/3] relative overflow-hidden bg-gray-100">
                                ...
                                <div className="absolute top-4 left-4">
                                    <div className="bg-orange-600 text-white text-xs font-black px-4 py-2 rounded-full shadow-lg flex items-center gap-1">
                            ...
                            <div className="p-6 space-y-3">
                                ...
                                <p className="text-gray-500 text-sm font-medium leading-relaxed bg-gray-50 p-4 rounded-2xl border border-gray-100 whitespace-pre-wrap">
                                    {post.description}
                                </p>
                                ...
                                <div className="pt-2 flex items-center justify-between border-t border-gray-50">
                                    ...
                                    <button className="flex items-center gap-1 text-[11px] font-black text-blue-500 bg-blue-50 px-3 py-1 rounded-full">
            ...
            <button 
                ...
                className="fixed bottom-8 right-6 w-16 h-16 bg-gradient-to-br from-orange-500 to-red-600 text-white rounded-full shadow-2xl shadow-orange-300 flex items-center justify-center active:scale-90 transition-transform z-[100]"
            >
                <RiAddLine size={32} />
            </button>
        </div>
