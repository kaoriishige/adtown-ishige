        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {TAG_OPTIONS[formData.category].map(tag => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm border transition-colors ${formData.tags.includes(tag)
          ...
          <div className="pt-4 pb-10">
            <button
              ...
              className={`w-full py-4 rounded-xl font-bold text-lg shadow-lg transition-all transform active:scale-95 flex items-center justify-center gap-2 ${isSubmitting || isCheckingAI || !formData.category || !formData.contactLineUrl || (formData.category === 'OTHER' && !formData.customCategory)
