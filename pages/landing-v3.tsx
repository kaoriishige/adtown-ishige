...
              <span className="text-yellow-300">
    93,000円</span><br className="sm:hidden" />も**損**しています。
            </h1>
...
          <div className="container mx-auto px-4 max-w-2xl"></div>
...
              あなたの「損」を「得」に変えるアプリ!!
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8 text-left max-w-4xl mx-auto">
              <div className="p-6 bg-gray-100 rounded-lg shadow-inner border border-gray-200">
                <h3 className="text-xl font-bold text-red-600 mb-2">食費の損!!</h3>
                <p className="font-bold text-lg mb-2">年間 約36,000円＋α</p>
                <p className="text-sm">地域スーパーチラシ比較アプリ</p>
              </div>
              <div className="p-6 bg-gray-100 rounded-lg shadow-inner border border-gray-200">
                <h3 className="text-xl font-bold text-red-600 mb-2">外食費の損!!</h3>
                <p className="font-bold text-lg mb-2">年間 約24,000円＋α</p>
                <p className="text-sm">地域の割引クーポン大集合アプリ</p>
              </div>
              <div className="p-6 bg-gray-100 rounded-lg shadow-inner border border-gray-200">
                <h3 className="text-xl font-bold text-red-600 mb-2">情報不足の損!!</h3>
                <p className="font-bold text-lg mb-2">年間 約15,000円＋α</p>
                <p className="text-sm">地域フードロスアプリ</p>
              </div>
              <div className="p-6 bg-gray-100 rounded-lg shadow-inner border border-gray-200">
                <h3 className="text-xl font-bold text-red-600 mb-2">時間の損!!</h3>
                <p className="font-bold text-lg mb-2">年間 約18,000円＋α</p>
...
                <span className="text-yellow-300">みんなの那須は...</span>
              </h2>
