    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
            <Head>
                ...
                <meta name="description" content="那須塩原市・那須町・大田原市のドラッグストアの特売チラシ一覧です。" />
            </Head>
            ...
            <main className="max-w-3xl mx-auto p-4 pb-20">
                <p className="text-sm text-gray-600 mb-6 bg-blue-100 p-4 rounded-xl border-l-4 border-blue-500 shadow-sm">
                    各店舗名をクリックすると、**トクバイ（外部サイト）**の特売ページへ移動します。新しいブラウザタブ/ウィンドウで開かれます。
                </p>
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            {stores.map((store, index) => (
                                <button
                                    ...
                                    className="block w-full text-left bg-white p-5 rounded-xl border border-gray-200 shadow-lg hover:shadow-xl hover:border-blue-500 transition-all duration-200 transform hover:-translate-y-0.5 group focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
            ...
            <footer className="bg-white border-t border-gray-200 py-6 text-center text-sm text-gray-500">
                ...
                <p className='text-xs mt-1'>Powered by Next.js</p>
            </footer>
        </div>
    );
};
