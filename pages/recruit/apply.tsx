...
const AddRecruitServicePage: NextPage = () => {
    ...
    const isFormValid = !!(companyName && agreed);
            ...
            <main className="container mx-auto px-6">
                ...
                <section ref={registrationFormRef} id="registration-form" className="mt-24 pt-10">
                    <div className="bg-white p-8 md:p-12 rounded-2xl shadow-2xl w-full max-w-3xl mx-auto border border-gray-200">
                        <div className="text-center mb-10"><ZapIcon className="w-12 h-12 mx-auto text-orange-500 mb-4" /><h2 className="text-3xl font-bold text-center mb-2">AI求人サービス 追加お申し込み</h2><p className="text-center text-gray-600">以下の登録情報をご確認の上、規約に同意してお申し込みください。</p></div>
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div> <label className="block text-gray-700 font-medium mb-2">所在地 *</label> <input type="text" value={address} readOnly className="w-full px-4 py-2 border rounded-lg bg-gray-100 cursor-not-allowed"/> </div>
                            ...
                            <div className="pt-4">
                                <label className="flex items-start">
                                    ...
                                    <span className="ml-3 text-sm text-gray-600">
                                        <button type="button" onClick={() => setShowTerms(true)} className="text-blue-600 hover:underline">利用規約</button>
                                        に同意し、AIマッチング求人サービスを追加で申し込みます。
                                    </span>
                                </label>
                            </div>
                            {stripeError && ( <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md flex items-center"><XCircleIcon className="h-5 w-5 mr-3"/><p className="text-sm">決済設定が不完全です。サイト管理者にご連絡ください。</p></div> )}
                ...
                <section className="mt-12 bg-white rounded-2xl shadow-xl p-8 md:p-12 w-full max-w-3xl mx-auto border border-gray-200 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        ...
                        ご希望の方は、**規約に同意した後**、下のボタンから**請求書PDFを即時ダウンロード**してご予約ください。
                    </p>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white p-6 rounded-lg max-w-2xl w-full max-h-[90vh] flex flex-col">
                        ...
                        <div className="overflow-y-auto space-y-4 pr-2">
                            ...
                            </p><ul className="list-disc list-inside pl-4 text-sm">
