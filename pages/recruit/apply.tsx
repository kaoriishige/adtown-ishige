            ...
            <main className="container mx-auto px-6">
                ...
                <section className="mt-12 bg-white rounded-2xl shadow-xl p-8 md:p-12 w-full max-w-3xl mx-auto border border-gray-200 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        ...
                        ご希望の方は、**規約に同意した後**、下のボタンから**請求書PDFを即時ダウンロード**してください。ご入金確認後にログイン情報をご連絡いたします。
                    </p>
                    ...
                    {!isFormValid && <p className="text-red-500 text-sm mt-2">※ PDFダウンロードには、フォームの必須項目を全て満たし、規約への同意が必要です。</p>}
                </section>
            </main>
