...
        setUser(user);
      } else {
        // ユーザーが存在しない場合もstateをnullにセット
        setUser(null);
      }
      // ▼▼▼ 【追加】Firebaseの認証チェックが完了したら、ローディングを解除 ▼▼▼
      setIsLoading(false);
      // ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
    });
    return () => unsubscribe();
  }, [auth]);
  ...
  // ▼▼▼ 【追加】ローディング完了後にリダイレクトを判断するuseEffectを追加 ▼▼▼
  useEffect(() => {
    // ローディング中でなく、かつユーザーが存在しない場合にリダイレクト
    if (!isLoading && !user) {
...
                ようこそ、<span className="font-bold">{user.displayName}</span> 様
              </p>
            )}
            {/* ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲ */}
          </div>
