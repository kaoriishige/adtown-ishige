  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-sans">
            ...
            <form className="p-8 md:p-10 space-y-6">
              ...
              <div className="flex items-start mt-4">
                ...
                <label htmlFor="terms" className="ml-2 text-sm font-medium text-gray-900">
                  <button type="button" onClick={() => setShowTerms(!showTerms)} className="text-orange-600 hover:underline">利用規約および個人情報の取扱い</button>に同意する
                </label>
              </div>
              {showTerms && (
                <div className="mt-4 p-4 bg-gray-100 rounded-lg h-80 overflow-y-auto text-sm text-gray-700 border border-gray-300">
                  <h4 className="font-bold mb-2 underline text-base text-gray-900">利用規約</h4>
                  <div className="space-y-4 pr-2 leading-relaxed">
                    <p><strong>第1条（適用）</strong><br />本規約は、株式会社adtown（以下「当社」といいます。）が提供するAIマッチング求人サービス（以下「本サービス」といいます。）の利用に関する一切の関係に適用されます。</p>
                    <p><strong>第2条（利用資格と審査）</strong><br />1.本サービスは、当社が別途定める審査基準を満たした法人または個人事業主（以下「パートナー」といいます。）のみが利用できるものとします。<br />2.当社は、パートナーが公序良俗に反する事業を行っている場合や、過去に規約違反があった場合、利用を承諾しない、または停止させることができます。</p>
                    <p><strong>第3条（利用料金と支払方法）</strong><br />
                      1. 本サービスの基本機能（求人情報の登録・掲載）は無料です。<br />
                      2. 有料機能（AIマッチング、AIアドバイス等）は、別途定める月額料金（税込8,800円、キャンペーン時は6,600円）が発生します。有料機能は日割り計算を行わず、停止手続きが完了した月の末日まで利用可能です。<br />
                      3. 支払い方法はクレジットカード決済のみとします。
                    </p>
                    <p><strong>第4条（禁止事項）</strong><br />
                      パートナーは、以下の行為を行ってはなりません。<br />
                      (a) 虚偽の求人情報の掲載、または実態と著しく異なる条件での募集。<br />
                      (b) 本サービスを通じて取得した求職者の個人情報を、採用活動以外の目的で使用、または第三者に提供する行為。<br />
                      (c) 当社、他のパートナー、または第三者の著作権、名誉、プライバシーを侵害する行為。
                    </p>
                    <p><strong>第5条（機密保持と個人情報の保護）</strong><br />
                      1. パートナーは、本サービスを利用するにあたり知り得た、当社または求職者の非公開情報を機密として保持し、第三者に漏洩してはなりません。<br />
                      2. パートナーは、求職者の個人情報を個人情報保護法および関連法令を遵守して適切に管理するものとします。
                    </p>
                    <p><strong>第6条（反社会的勢力の排除）</strong><br />
                      パートナーは、現在、暴力団等の反社会的勢力に該当しないこと、および将来にわたっても該当しないことを表明し、保証するものとします。これに反したことが判明した場合、当社は催告を要せず直ちに利用登録を抹消できます。
                    </p>
                    <p><strong>第7条（免責事項）</strong><br />
                      1. 当社は、本サービスによる採用の成否、求職者が提供する情報の真実性、正確性について何ら保証するものではありません。<br />
                      2. パートナーと求職者との間で生じたトラブル（面接のキャンセル、採用後の条件相違等）は、当事者間で解決するものとし、当社は一切の責任を負いません。
                    </p>
                    <p className="text-xs text-gray-500 italic mt-4">2024年4月1日 施行</p>
                  </div>
                </div>
              )}
              {error && (
      ...
      <footer className="bg-gray-800 text-white py-12 text-center">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-left border-b border-gray-700 pb-8">
          <div>
            <h5 className="font-bold mb-4 text-lg">運営会社</h5>
            <p className="text-sm opacity-80">株式会社adtown<br />栃木県那須塩原市共墾社108-2</p>
          </div>
          <div>
            <h5 className="font-bold mb-4 text-lg">リンク</h5>
            <ul className="text-sm opacity-80 space-y-2">
              <li><Link href="/privacy-policy" className="hover:text-orange-400">プライバシーポリシー</Link></li>
              <li><Link href="/terms" className="hover:text-orange-400">利用規約</Link></li>
              <li><Link href="/tokushoho" className="hover:text-orange-400">特定商取引法に基づく表記</Link></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold mb-4 text-lg">お問い合わせ</h5>
            <p className="text-sm opacity-80">お困りの際はダッシュボード内、または公式サイトよりご連絡ください。</p>
          </div>
        </div>
