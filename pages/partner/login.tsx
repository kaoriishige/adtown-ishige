      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-right text-sm">
            <Link href="/partner/forgot-password" legacyBehavior>
                <a className="text-blue-600 hover:underline">パスワードをお忘れですか？</a>
            </Link>
          </div>
        ...
        <p className="text-sm text-center mt-6">
          アカウントをお持ちでないですか？ <Link href="/partner/signup" legacyBehavior><a className="text-blue-600 hover:underline">新規登録</a></Link>
        </p>
      </div>
    </div>
  );
