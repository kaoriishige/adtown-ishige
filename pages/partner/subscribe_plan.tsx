...
const PRICE_ID_ANNUAL = 
    process.env.NEXT_PUBLIC_STRIPE_AD_ANNUALCR_PRICE_ID || 
    process.env.NEXT_PUBLIC_STRIPE_AD_ANNUAL_PRICE_ID || 
    'missing_annualcr_id'; 

// 年額（請求書）: 複数の環境変数名を考慮
const PRICE_ID_ANNUAL_INVOICE = 
    process.env.NEXT_PUBLIC_STRIPE_AD_ANNUAL__INVOICE_PRICE_ID || 
    process.env.NEXT_PUBLIC_STRIPE_AD_ANNUAL_INVOICE_PRICE_ID || 
