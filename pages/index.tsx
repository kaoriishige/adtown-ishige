  ...
  return (
    <>
      ...
      <div className="bg-white text-gray-800">
        ...
        {/* --- ヒーローセクション --- */}
        <header className="relative bg-blue-800 text-white overflow-hidden py-20 md:py-32" style={{backgroundImage: `
          linear-gradient(135deg, rgba(255, 255, 255, 0.1) 25%, transparent 25%),
          linear-gradient(225deg, rgba(255, 255, 255, 0.1) 25%, transparent 25%),
          linear-gradient(45deg, rgba(255, 255, 255, 0.1) 25%, transparent 25%),
          linear-gradient(315deg, rgba(255, 255, 255, 0.1) 25%, transparent 25%)
        `, backgroundPosition: '10px 0, 10px 0, 0 0, 0 0', backgroundSize: '20px 20px'}}>
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">
              {data.mainTitle}
            </h1>
            <p className="mt-2 text-md text-blue-200 mb-8">
            ...
            <div className="flex justify-center">
              <a href="#cta" className="bg-lime-400 text-black font-bold py-4 px-8 rounded-full shadow-lg transition-all transform hover:scale-105 inline-block text-lg whitespace-nowrap">
                LINEでオープン通知を受け取る
              </a>
            </div>
          </div>
            ...
            <div className="container mx-auto px-6 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
                ...
                <div className="w-full h-auto flex justify-center items-center">
                  <Image src="/images/partner-ishikawa.png" alt="おまかせオート石川" width={180} height={80} style={{objectFit: "contain", maxWidth: '100%', height: 'auto'}} unoptimized />
                </div>
                <div className="w-full h-auto flex justify-center items-center">
                  <Image src="/images/partner-midcity.png" alt="那須ミッドシティホテル" width={180} height={80} style={{objectFit: "contain", maxWidth: '100%', height: 'auto'}} unoptimized />
                </div>
                <div className="w-full h-auto flex justify-center items-center">
                  <Image src="/images/partner-dairin.png" alt="オートギャラリーダイリン" width={180} height={80} style={{objectFit: "contain", maxWidth: '100%', height: 'auto'}} unoptimized />
                </div>
                <div className="w-full h-auto flex justify-center items-center">
                  <Image src="/images/partner-akimoto.png" alt="株式会社パン・アキモト" width={180} height={80} style={{objectFit: "contain", maxWidth: '100%', height: 'auto'}} unoptimized />
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="cta" className="bg-gray-800 text-white">
            <div className="container mx-auto px-6 py-20 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <div className="mt-8">
                  <a href="https://lin.ee/rFvws11" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white font-bold text-lg py-4 px-10 rounded-full shadow-lg transition-transform transform hover:scale-105 inline-block whitespace-nowrap">
                    LINEでオープン通知を受け取る
                  </a>
                </div>
              </div>
