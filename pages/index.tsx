...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const fallbackData: LandingData = {
    ...
    problemItem5_Desc: 'まだ美味しく食べられるのに、形が悪いだけで捨てられてしまう野菜や、閉店間際のパンやお惣菜。この「もったいない」を見過ごすことで、あなたは食費をさらに圧縮できるチャンスを逃しています。このアプリは、地域の飲食店や小売店のリアルタイムのフードロス情報をあなたに届けます。環境に優しく、お財布にもっと優しい選択が、毎日可能になります。',
