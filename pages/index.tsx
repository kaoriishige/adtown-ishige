...
const FeatureCard = ({ icon, title, description }: { icon: React.ReactNode, title?: string, description?: string }) => (
  <div className="bg-[#161b22] p-8 rounded-xl border border-gray-700/50 h-full transition-all duration-300 hover:border-cyan-400/50 hover:shadow-xl hover:shadow-cyan-500/10">
...
    	</Head>
      ...
      {/* ▼▼▼ この一番外側のdivに背景エフェクトを追加しました ▼▼▼ */}
    	<div className="bg-[#0d1117] text-gray-300 relative overflow-hidden">
        {/* 背景の光エフェクト */}
        <div className="absolute top-0 left-0 w-full h-full -z-0">
          <div className="absolute top-[-200px] left-[-200px] w-[500px] h-[500px] bg-gradient-radial from-blue-900/50 to-transparent blur-3xl animate-pulse"></div>
          <div className="absolute bottom-[-200px] right-[-200px] w-[500px] h-[500px] bg-gradient-radial from-cyan-900/50 to-transparent blur-3xl animate-pulse animation-delay-2000"></div>
        </div>

        {/* ページ全体のコンテンツはここから */}
        <div className="relative z-10">
          {/* --- ヒーローセクション --- */}
    	    <header className="py-24 md:py-32 text-center border-b border-white/10">
